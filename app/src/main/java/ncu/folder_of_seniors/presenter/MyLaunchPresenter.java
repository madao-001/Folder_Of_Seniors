 ...
 */
public class MyLaunchPresenter extends BasePresenter<MyLaunchView, MyLaunchModel> implements MyLaunchPresenterImpl {
    ...
    public void deleteData(Resource resource) {
        getModel().deleteData(resource, new RegisterLisentener() {
            @Override
